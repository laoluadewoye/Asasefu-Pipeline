...
export const metadata: Metadata = {
    title: "Results | Archive Ingestor",
    description: "Results page for my Archive Ingestor front end."
};
...
export default async function Page() {
    ...
    return (
        <div id="results" className={`${currentThemeColors.mainBgColor} ${currentThemeColors.mainTextColor}`}>Hello Results</div>
    );
}
